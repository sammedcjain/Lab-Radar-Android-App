...
class ada5 extends Form implements HandlesEventDispatching {
  ...
  protected void $define() {
    ...
    TextBox1.Text("5. From a given vertex in a weighted connected graph, find shortest paths to other vertices
    usingDijkstra's algorithm.Analyze its time efficiency.");
    ...
    TextBox2.Text("5)  // Dijkstra's Algorithm in C
    #include <stdio.h>
